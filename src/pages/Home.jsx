...
function Home() {
  ...
  return (
    ...
    <div className={`${Styles.heroContent} relative`}>
      ...
      <button onClick={() => navigate('/gallery')} className={`${Styles.fadeItem} bg-black/40 text-sm  border-2 rounded-2xl px-3 py-2 cursor-pointer 
  ...
  <div className={Styles.frist}>
    ...
    <div className={Styles.rightCol}>
      ...
      <img src="/images/sofa1.jpg" alt="sofa1" className={Styles.smallImg} />
      <img src="/images/sofa1.jpg" alt="sofa1" className={Styles.smallImg} />
      <img src="/images/sofa1.jpg" alt="sofa1" className={Styles.smallImg} />
    </div>
  </div>
